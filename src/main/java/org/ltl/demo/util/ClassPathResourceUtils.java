...
public final class ClassPathResourceUtils {
	...
	public final static String getResourceAsString(String path)
			throws Exception {
		byte[] bytes = getResounceAsByte(path);
		return new String(bytes);
	}

	public final static String getResourceAsString(String path, String charset)
			throws Exception {
		byte[] bytes = getResounceAsByte(path);
